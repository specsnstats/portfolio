...
export default function Socials() {
    ...
    return(
        <div className="uk-margin-small-top uk-flex-center uk-flex">
            ...
            <a href="https://discordapp.com/users/332235875670818816" target="_blank" rel="noreferrer"><ReactMarkdown className="uk-margin-small-right">![Discord](https://img.shields.io/badge/-Discord-5865F2?style=plastic&logo=discord&logoColor=white)</ReactMarkdown></a>
